...
class AdvertsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
        	...
        	['title' => 'Pedigree Daschunds for sale', 'description' => 'Available to vetted homes only. Pedigree. Amazing pets and great with kids.', 'price' => '250000.00', 'category' => '3', 'user_id' => '1'],
